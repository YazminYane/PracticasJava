...
import fes.aragon.archivos.asint4.Lexico;
import fes.aragon.archivos.asint4.Token;
import fes.aragon.archivos.asint4.Tokens;
 ...
 * @author Axel
 */
public class Sintactico4 extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Sintactico4
     */
    public Sintactico4(Seleccion ventanaAnterior) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Programa 11: Sintáctico 4");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Sintactico4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Sintactico4(null).setVisible(true);
            }
        });
    }
